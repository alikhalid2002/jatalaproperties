...
export const initialFarmers = [
  ...
  { nameUr: 'بشیر احمد', nameEn: 'Bashir Ahmad', landSize: 12, landUnit: 'Kanals', status: 'Pending', totalPaid: 45000, totalRemaining: 15000, history: [
  ...
  { nameUr: 'غلام نبی', nameEn: 'Ghulam Nabi', landSize: 15, landUnit: 'Kanals', status: 'Paid', totalPaid: 65000, totalRemaining: 0, history: [
  ...
  { nameUr: 'مشتاق علی', nameEn: 'Mushtaq Ali', landSize: 18, landUnit: 'Kanals', status: 'Paid', totalPaid: 85000, totalRemaining: 0, history: [
